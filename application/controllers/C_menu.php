...
class C_menu extends CI_Controller {
	...
	public function search()
	{
		...
		$data['ruang'] = $this->M_ruang->getRuangSearch($keyword);
		$this->load->view('search', $data);
	}

	public function kuotaRuang() {
		$min = $this->input->post('min');
		$max = $this->input->post('max');
		$data['ruang'] = $this->M_ruang->searchBetween($min, $max);
		$this->load->view('kuotaRuang', $data);
	}

	public function cariKuota() {
		$min = $this->input->post('min');
		$max = $this->input->post('max');
		$data['ruang'] = $this->M_ruang->searchBetween($min, $max);
		$this->load->view('kuotaRuang', $data);
